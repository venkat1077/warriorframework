...
def create_and_start_process_with_queue(target_module, args_dict, jobs_list, output_q, p_name=''):
    """Creates python multiprocesses for the provided target module with the proivded arguments and  starts them 
...
def update_attribute(dict1, dict2):
    ...
    """
    keys = ["errors", "failures", "skipped", "passes", "exceptions", "keywords"]
    for key in keys:
        if key in dict1:
